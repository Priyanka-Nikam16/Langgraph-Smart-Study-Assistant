...
- Classifier node: Decide the question type
- Theory node: Explain the concept 
- Code node : Generate the code
...
- Static edge : Always go next 
- Condition edge : Decision based routing
